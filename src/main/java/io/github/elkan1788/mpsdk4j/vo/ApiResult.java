...
public class ApiResult {
    ...
    public ApiResult(String json) {
        ...
        this.errCNMsg = this.errCode == null ? "" : _cr.get(String.valueOf(this.errCode));
    ...
    public boolean isAccessTokenInvalid() {
        return this.errCode != null
               && (this.errCode.intValue() == 40001
                   || this.errCode.intValue() == 42001
                   || this.errCode.intValue() == 42002
                   || this.errCode.intValue() == 40014);
    }
}
